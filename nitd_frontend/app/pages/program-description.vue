  ...
  <div class="bg-[#F4F4F0] min-h-screen text-black font-mono selection:bg-red-500 selection:text-white pb-32 pt-32 lg:pt-40 relative overflow-hidden">
    ...
    <div class="max-w-[1200px] mx-auto px-6 relative z-10">
      ...
      <div class="text-center mb-16">
        <div class="font-pixel text-red-600 text-sm md:text-base mb-4 uppercase tracking-widest font-bold">
          [ КАФЕДРА МЕРЕЖЕВИХ ТА ІНТЕРНЕТ ТЕХНОЛОГІЙ ]
        </div>
        <h1 class="text-3xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-tight bg-black text-white inline-block px-6 py-4 shadow-[8px_8px_0px_0px_rgba(220,38,38,1)]">
          ОПИС ОСВІТНЬОЇ ПРОГРАМИ <br>ДЛЯ ОР "БАКАЛАВР" 2025
        </h1>
      </div>
      ...
      <div class="border-8 border-black bg-zinc-200 shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] mb-20 relative flex flex-col h-[70vh] md:h-[85vh]">
        ...
        <div class="bg-black text-white p-3 flex justify-between items-center border-b-4 border-black shrink-0">
          <div class="flex items-center gap-4">
            <span class="font-pixel text-xs text-red-500 animate-pulse">● SECURE_DOC</span>
            <span class="font-mono text-xs hidden md:inline">ID_69751_ACCREDITATION</span>
          </div>
          <a href="/docs/program-2025.pdf" download class="font-pixel text-[10px] bg-white text-black px-3 py-1 hover:bg-red-500 hover:text-white transition-colors cursor-pointer border-2 border-white">
            [ ЗАВАНТАЖИТИ PDF ]
          </a>
        </div>
        ...
        <div class="flex-grow relative w-full h-full bg-white">
          <!-- ЗМІНИ ШЛЯХ ДО СВОГО PDF ФАЙЛУ ТУТ -->
          <iframe 
            src="documentes/OOP_bac2025.pdf#toolbar=0" 
      ...
      <div class="max-w-3xl mx-auto bg-white border-4 border-black p-8 md:p-12 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative">
        ...
        <div class="absolute -top-6 -left-6 bg-red-600 text-white font-pixel text-4xl w-12 h-12 flex items-center justify-center border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ?
        </div>
        ...
        <form @submit.prevent="submitFeedback" class="flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-2">
            ...
            <input 
              ...
              required
              placeholder="Name" 
              class="w-full border-2 border-black p-4 font-mono focus:outline-none focus:border-red-600 focus:shadow-[4px_4px_0px_0px_rgba(220,38,38,1)] transition-all bg-[#F4F4F0]"
            />
          </div>
          ...
          <div class="flex flex-col gap-2">
            ...
            <textarea 
              ...
              placeholder="Text" 
              rows="5"
              class="w-full border-2 border-black p-4 font-mono focus:outline-none focus:border-red-600 focus:shadow-[4px_4px_0px_0px_rgba(220,38,38,1)] transition-all bg-[#F4F4F0] resize-y"
            ></textarea>
          </div>
          ...
          <button 
            ...
            class="bg-red-600 text-white font-pixel text-lg md:text-xl uppercase py-5 px-8 border-4 border-black hover:bg-black transition-colors shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
          >
...
const submitFeedback = async () => {
  ...
  try {
    ...
    statusMessage.value = '[ ПОМИЛКА ] НЕ ВДАЛОСЯ ВІДПРАВИТИ ДАНІ. ПЕРЕВІРТЕ ЗВ\'ЯЗОК.';
