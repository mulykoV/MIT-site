    ...
    <div class="max-w-[1400px] mx-auto px-6 relative z-10">
      ...
      <div class="border-b-8 border-black pb-8 mb-12 flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div class="flex flex-col gap-2 shrink-0">
          <NuxtLink to="/" class="font-pixel text-xs bg-white text-black px-6 py-3 uppercase border-4 border-black hover:bg-lime-400 hover:text-black transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center">
            ← НА ГОЛОВНУ
          </NuxtLink>
        </div>
      </div>
